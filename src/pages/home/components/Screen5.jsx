...
function Screen5() {
    return (
        <div className='text-white flex flex-col items-center gap-10'>
            <div className="">
                <h2 className='text-center text-5xl'>In Case You </h2>
                <h2 className='text-center text-5xl'>Missed Anything</h2>
            </div>
            <div className="divide-y w-[80%] xl:w-3/4 divide-[#333] space-y-5">
                ...
                <FAQ ans={'All EGOZE live on the Ethereum blockchain. (ERC721A Smart Contracts)'}
...
function FAQ({ question, ans }) {
    ...
    return (
        <div className="w-full flex flex-col justify-center gap-5 divide-y divide-[#333]">
            ...
            <div className={`${show ? 'block text-[#333] text-xl' : 'hidden'}`}>{ans}</div>
        </div>
    )
}