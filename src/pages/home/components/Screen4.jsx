        ...
        <div className='space-y-10'>
            ...
            <div className='w-full  flex flex-col justify-center items-center gap-10 text-white  overflow-x-auto'>
                <div className="w-[1000px] space-y-7 py-10 ">
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div className="w-[100px] h-[100px] relative flex flex-col gap-3 justify-center items-center hover:scale-110 duration-200 cursor-pointer" onClick={() => { setSelected(1) }} >
                            <div className="absolute w-full h-full bg-[#F5841F]/60" style={{ filter: 'blur(46px)' }}></div>
                            <img src={metaMaskIcon} alt="" />
                            <p>METAMASK</p>
                        </div>
                        <div className="w-[100px] h-[100px] relative flex justify-center items-center hover:scale-110 duration-200 cursor-pointer" onClick={() => { setSelected(2) }} >
                            <div className="absolute w-full h-full bg-[#E57FED]/60" style={{ filter: 'blur(46px)' }}></div>
                            <img src={ETHIcon} alt="" />
                        </div>
                        <div className="w-[100px] h-[100px] relative flex justify-center items-center hover:scale-110 duration-200 cursor-pointer" onClick={() => { setSelected(3) }} >
                            <div className="absolute w-full h-full bg-[#6000B6]/60" style={{ filter: 'blur(46px)' }}></div>
                            <img src={nftIcon} alt="" />
                        </div>
                        <div className="w-[100px] h-[100px] relative flex justify-center items-center hover:scale-110 duration-200 cursor-pointer" onClick={() => { setSelected(4) }} >
...
const Selected1 = ({ setSelected }) => {
    return (
        <div className="selected-1 px-[5%] md:px-[10%] text-white space-y-5 min-h-screen h-full">
            ...
            <p>Download MetaMask from the wallet’s website or click “Download Now” Button. </p>
            <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' >Downlaod Now</button>
            <p>MetaMask can be added to several browsers such as Brave, Google Chrome, Edge, Firefox, as well as Android or iOS mobile devices.</p>

            <p>1.Click on ‘Download’. A new tab will open and you’ll be able to add MetaMask to your browser.</p>

            <div className="flex justify-center">
                <img src={metamaskDownloadIcon} height={72} alt="" />
            </div>

            <p>2.Complete the on screen process for creating you MetaMask account.</p>
            ...
            <button className='bg-white text-black w-[256px] h-[56px] rounded float-right hover:scale-110 duration-200' onClick={() => { setSelected(2) }}>NEXT</button>
        </div>
    )
}
...
const Selected2 = ({ setSelected }) => {
    return (
        <div className="selected-2 px-[10%] text-white space-y-5 min-h-screen h-full">
            <div className="flex  items-center gap-5">
            ...
            <p>Now that your MetaMask wallet is set up, you can add ETH to your account.</p>

            <p >1.Click on 'Buy' to add ETH to your wallet</p>

            <img src={ethBuy} alt="" height={250} />

            <p>2.Choose your country and preferred payment method and proceed to make payment</p>

            <div className="flex justify-between">
                <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' onClick={() => { setSelected(1) }}>BACK</button>
                <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' onClick={() => { setSelected(3) }}>NEXT</button>
            </div>
...
const Selected3 = ({setSelected}) => {
    return (
        <div className="selected-1 px-[10%] text-white space-y-5 min-h-screen h-full">
            <div className="flex  items-center gap-5">
                <div className="w-[100px] h-[100px] relative flex justify-center items-center hover:scale-110 duration-200 cursor-pointer"  >
                    <div className="absolute w-full h-full bg-[#6000B6]/60" style={{ filter: 'blur(46px)' }}></div>
                    <img src={nftIcon} alt="" />
            ...
            <p>1. Navigate to the VapeMonkey NFT Marketplace</p>
            ...
            <p>2. Connect your MetaMask wallet and authorize your Ethereum account.</p>

            <p>3. The mint price for a VapeMonkey NFT is 0.05 ETH. Make sure you have enough ETH in your wallet to purchase the NFT.</p>

            <p>4. Follow the instructions on the website to mint (purchase) your VapeMonkey NFT.</p>

            <div className="flex justify-between">
                <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' onClick={() => { setSelected(2) }}>BACK</button>
                <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' onClick={() => { setSelected(4) }}>NEXT</button>
            </div>
...
const Selected4 = ({setSelected})=>{
    return(
        <div className="selected-1 px-[10%] text-white space-y-10 min-h-screen h-full">
                <div className="flex  items-center gap-5">
                    <div className="w-[100px] h-[100px] relative flex justify-center items-center hover:scale-110 duration-200 cursor-pointer" >
                        <div className="absolute w-full h-full bg-[#5AACA7]/60" style={{ filter: 'blur(46px)' }}></div>
                        <img src={redeem} className='' alt="" />
                    </div>
                ...
                <button className='bg-white text-black w-[256px] h-[56px] rounded hover:scale-110 duration-200' onClick={() => { setSelected(3) }}>BACK</button>
            </div>
    )
}